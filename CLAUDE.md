...
**MYS-0002 — Fecha límite de armado (⚠️ commiteado solo en `origin`/bruscofacundo1 — NO pusheado a `myselec`/producción todavía, a propósito. Verificar `git log myselec/main..HEAD` antes de asumir que está deployado)**
...
- Commit: `b3a5a2e` en `origin` (bruscofacundo1). Falta decidir cuándo pushear a `myselec` para que se dispare el deploy a producción.
